  ...
  return (
    <PopoverPrimitive.Portal>
      <PopoverPrimitive.Content
        ...
        className={cn(
          "z-50 flex w-[296px] origin-(--radix-popover-content-transform-origin) flex-col gap-2.5 rounded-[var(--radius)] border border-border bg-popover p-4 text-sm text-popover-foreground shadow-[var(--shadow-panel)] outline-hidden duration-100",
